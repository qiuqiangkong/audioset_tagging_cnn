...
from hdfs_data_generator import HdfsAudioSetDataset
...
def train(args):
    ...
    train_indexes_hdf5_path = os.path.join(workspace, 'hdfs', 'indexes', 
        '{}.h5'.format(data_type))

    eval_bal_indexes_hdf5_path = os.path.join(workspace, 
        'hdfs', 'indexes', 'balanced_train.h5')

    eval_test_indexes_hdf5_path = os.path.join(workspace, 'hdfs', 'indexes', 
        'eval.h5')
    ...
    dataset = HdfsAudioSetDataset(clip_samples=clip_samples, classes_num=classes_num)
