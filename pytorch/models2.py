...
class Cnn14_Transformer_nopos(nn.Module):
    def __init__(self, sample_rate, window_size, hop_size, mel_bins, fmin, 
        ...
        self.fc0 = nn.Linear(2048, 512)
        self.transformer = TransformerModel(ninp=512, nhead=8, nhid=512, nlayers=1, dropout=0.2, pos_enc=False)
...
class Cnn14_small_16k_emb1024(nn.Module):
    def __init__(self, sample_rate, window_size, hop_size, mel_bins, fmin, fmax, classes_num):
        
        super(Cnn14_small_16k_emb1024, self).__init__() 
...
class Wavegram_Logmel_Cnn14_16k(nn.Module):
    def __init__(self, sample_rate, window_size, hop_size, mel_bins, fmin, fmax, classes_num):
        
        super(Wavegram_Logmel_Cnn14_16k, self).__init__() 
    ...
    def forward(self, input, mixup_lambda=None):
        ...
        a1 = self.pre_block1(a1, pool_size=2)
