...
def train(args):
    ...
    train_indexes_hdf5_path = os.path.join(workspace, 'hdf5s_mp3', 'indexes', 
        '{}.h5'.format(data_type))

    eval_bal_indexes_hdf5_path = os.path.join(workspace, 
        'hdf5s_mp3', 'indexes', 'balanced_train.h5')

    eval_test_indexes_hdf5_path = os.path.join(workspace, 'hdf5s_mp3', 'indexes', 
        'eval.h5')
